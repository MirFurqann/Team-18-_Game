...
# This function draws text on a given surface within a specified rectangle, handling word wrapping.
...
# This function implements an input window for the user to enter a number using Pygame interface.
